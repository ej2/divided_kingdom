...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.npc'
        db.add_column(u'location_service', 'npc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['npc.NPC'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.npc'
        db.delete_column(u'location_service', 'npc_id')
    ...
    models = {
        ...
        u'npc.npc': {
            ...
            'personality': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
