...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Route.combat_chance'
        db.add_column(u'location_route', 'combat_chance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Route.event_chance'
        db.add_column(u'location_route', 'event_chance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Route.combat_chance'
        db.delete_column(u'location_route', 'combat_chance')

        # Deleting field 'Route.event_chance'
        db.delete_column(u'location_route', 'event_chance')
