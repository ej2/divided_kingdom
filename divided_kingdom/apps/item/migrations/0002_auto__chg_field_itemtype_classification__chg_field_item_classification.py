...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemType.classification'
        db.alter_column(u'item_itemtype', 'classification', self.gf('django.db.models.fields.CharField')(max_length=6))

        # Changing field 'Item.classification'
        db.alter_column(u'item_item', 'classification', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'ItemType.classification'
        db.alter_column(u'item_itemtype', 'classification', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Item.classification'
        db.alter_column(u'item_item', 'classification', self.gf('django.db.models.fields.CharField')(max_length=3))
