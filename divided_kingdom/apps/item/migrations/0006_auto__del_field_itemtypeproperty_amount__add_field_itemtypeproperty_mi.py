...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemTypeProperty.amount'
        db.delete_column(u'item_itemtypeproperty', 'amount')

        # Adding field 'ItemTypeProperty.min_amount'
        db.add_column(u'item_itemtypeproperty', 'min_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ItemTypeProperty.max_amount'
        db.add_column(u'item_itemtypeproperty', 'max_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ItemTypeProperty.amount'
        raise RuntimeError("Cannot reverse this migration. 'ItemTypeProperty.amount' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ItemTypeProperty.amount'
        db.add_column(u'item_itemtypeproperty', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'ItemTypeProperty.min_amount'
        db.delete_column(u'item_itemtypeproperty', 'min_amount')

        # Deleting field 'ItemTypeProperty.max_amount'
        db.delete_column(u'item_itemtypeproperty', 'max_amount')
