...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mob.player'
        db.add_column(u'mob_mob', 'player',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['player.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mob.player'
        db.delete_column(u'mob_mob', 'player_id')
