...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mob.xp_amount'
        db.add_column(u'mob_mob', 'xp_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MobType.xp_amount'
        db.add_column(u'mob_mobtype', 'xp_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mob.xp_amount'
        db.delete_column(u'mob_mob', 'xp_amount')

        # Deleting field 'MobType.xp_amount'
        db.delete_column(u'mob_mobtype', 'xp_amount')
    ...
    models = {
        ...
        u'mob.mob': {
            ...
            'xp_amount': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'mob.mobencounter': {
