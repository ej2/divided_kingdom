...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reward.health'
        db.add_column(u'game_reward', 'health',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Reward.stamina'
        db.add_column(u'game_reward', 'stamina',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reward.health'
        db.delete_column(u'game_reward', 'health')

        # Deleting field 'Reward.stamina'
        db.delete_column(u'game_reward', 'stamina')
