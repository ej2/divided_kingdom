...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_eventlog', (
            ...
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['player.Player'])),
            ('game_event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['game.GameEvent'])),
            ('resolved', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'game', ['EventLog'])


    def backwards(self, orm):
        # Deleting model 'EventLog'
        db.delete_table(u'game_eventlog')
