...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameEvent.title'
        db.add_column(u'game_gameevent', 'title',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=50),
                      keep_default=False)

        # Adding field 'EventAction.title'
        db.add_column(u'game_eventaction', 'title',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameEvent.title'
        db.delete_column(u'game_gameevent', 'title')

        # Deleting field 'EventAction.title'
        db.delete_column(u'game_eventaction', 'title')
