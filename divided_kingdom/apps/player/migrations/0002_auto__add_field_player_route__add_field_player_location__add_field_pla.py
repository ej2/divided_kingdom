...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.route'
        db.add_column(u'player_player', 'route',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.Route'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Player.location'
        db.add_column(u'player_player', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Player.distance_marker'
        db.add_column(u'player_player', 'distance_marker',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.route'
        db.delete_column(u'player_player', 'route_id')

        # Deleting field 'Player.location'
        db.delete_column(u'player_player', 'location_id')

        # Deleting field 'Player.distance_marker'
        db.delete_column(u'player_player', 'distance_marker')
