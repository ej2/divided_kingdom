...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MotivatingForce'
        db.create_table(u'player_motivatingforce', (
        ...
        db.send_create_signal(u'player', ['MotivatingForce'])

        # Adding field 'Player.motivating_force'
        db.add_column(u'player_player', 'motivating_force',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['player.MotivatingForce'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MotivatingForce'
        db.delete_table(u'player_motivatingforce')

        # Deleting field 'Player.motivating_force'
        db.delete_column(u'player_player', 'motivating_force_id')
